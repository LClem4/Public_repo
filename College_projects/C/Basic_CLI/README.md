...
# Description
  The purpose of this programming project was to design a basic command line interpreter with the description 
  and functionality listed below.
...
# Run
  Actual program: ./wish
  Test cases: ./test-wish.sh

# Source
This project is taken from the website: https://pages.cs.wisc.edu/~remzi/OSTEP/ witten by
